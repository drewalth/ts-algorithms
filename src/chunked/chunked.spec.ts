...
describe('chunked functions', () => {
  ...
  describe('chunked', () => {
    ...
    it('should throw error for invalid chunk size', () => {
      expect(() => chunked([1, 2, 3], 0)).toThrow('Cannot chunk with count <= 0!');
      expect(() => chunked([1, 2, 3], -1)).toThrow('Cannot chunk with count <= 0!');
    });
  ...
  describe('evenlyChunked', () => {
    ...
    it('should throw error for invalid number of chunks', () => {
      expect(() => evenlyChunked([1, 2, 3], -1)).toThrow("Can't divide into a negative number of chunks");
      expect(() => evenlyChunked([1, 2, 3], 0)).toThrow("Can't divide a non-empty array into 0 chunks");
    });
